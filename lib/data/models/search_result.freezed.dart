...
mixin _$SearchResult {
 ...
 MedicalRecord get record;/// 包含高亮 HTML 标签的摘要
 String get snippet;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchResult&&(identical(other.record, record) || other.record == record)&&(identical(other.snippet, snippet) || other.snippet == snippet));
}
...
@useResult
$Res call({
 MedicalRecord record, String snippet
});
...
/// Create a copy of SearchResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? record = null,Object? snippet = null,}) {
  return _then(_self.copyWith(
record: null == record ? _self.record : record // ignore: cast_nullable_to_non_nullable
as MedicalRecord,snippet: null == snippet ? _self.snippet : snippet // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of SearchResult
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( MedicalRecord record,  String snippet)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchResult() when $default != null:
return $default(_that.record,_that.snippet);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( MedicalRecord record,  String snippet)  $default,) {final _that = this;
switch (_that) {
case _SearchResult():
return $default(_that.record,_that.snippet);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( MedicalRecord record,  String snippet)?  $default,) {final _that = this;
switch (_that) {
case _SearchResult() when $default != null:
return $default(_that.record,_that.snippet);case _:
  return null;
...
@override final  MedicalRecord record;
/// 包含高亮 HTML 标签的摘要
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SearchResult&&(identical(other.record, record) || other.record == record)&&(identical(other.snippet, snippet) || other.snippet == snippet));
}
...
@override $MedicalRecordCopyWith<$Res> get record;
...
/// Create a copy of SearchResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? record = null,Object? snippet = null,}) {
